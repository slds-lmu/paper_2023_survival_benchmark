# see extralearners-ncv.R

# Copied from https://github.com/mlr-org/mlr3extralearners/blob/afc70b45f332ad78460f7dbd3da8d15cac41315e/R/learner_mgcv_surv_gam_cox.R#L31-L155
# with adjustments for automatic spline handling in the formula for continuous variables
  ...
  private = list(
    .train = function(task) {
      ...
      if (is.null(pars$formula)) {
        ...
        pars$formula = generate_gam_formula(task, min_vals = 10)
      }
...
x$add("surv.gam.cox", LearnerSurvGamCox)
rm(x)
# lrn("surv.gam.cox")
