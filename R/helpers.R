...
# Plackett-Luce helpers -----------------------------------------------------------------------

#' Prepare PlackettLuce rankings from raw scores
#'
#' Filters scores by measure, averages per learner-task, ranks within tasks,
#' and builds a PlackettLuce rankings object.
#'
#' @param scores_all Raw scores data.table with columns learner_id, task_id, tune_measure, and measure columns.
#' @param measure Character, measure column name (e.g. "harrell_c", "isbs").
