...
In general, results are divided by udnerlying tuning measure, i.e. `harrel_c` and `rcll`, with the former being a measure of discrimination and the latter a scoring rule.
...
table_aggr(aggr_scores, eval_measure_id = "brier_improper", tuning_measure_id = "harrell_c")
