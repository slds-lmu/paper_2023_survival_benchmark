...
#| fig-width: 10
plot_results(bma = bma_isbs, type = "cd_bd", measure_id = "rcll", tuning_measure_id = "rcll", ratio = cd_ratio, baseline = "CPH")
```


```{r critical-difference-baseline-diff-rcll-isbs}
#| fig-width: 10
plot_results(bma = bma_isbs, type = "cd_bd", measure_id = "isbs", tuning_measure_id = "rcll", ratio = cd_ratio, baseline = "CPH")
```
