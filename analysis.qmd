...
plot_results(bma = bma_rcll, type = "cd_bd", measure_id = "brier_improper", tuning_measure_id = "rcll", ratio = 1, baseline = "CPH")
```
...
```{r dcalibration-heatmap}
#| fig-width: 10
#| fig-height: 8

bma[, dcalib_p := pchisq(dcalib, 10 - 1, lower.tail = FALSE)]
# bma[, dcalib_p_bh := p.adjust(dcalib_p, method = "holm")]
  ...
  p = ggplot(bma[tuned == tuned_on], 
    ...
    labs(
      ...
      subtitle = glue::glue(
        ...
        "Learners ordered by average p-value"
      ),
